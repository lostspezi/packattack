...
import { MegaMenuCollection } from "./mega-menu-collection";

export type MegaMenuSection = "battles" | "packs" | "collection" | null;
        ...
        >
          ...
          >
            ...
            {activeSection === "collection" && (
              <MegaMenuCollection lang={lang} dict={dict} onClose={onClose} />
            )}
          </div>
        </motion.div>
      )}
