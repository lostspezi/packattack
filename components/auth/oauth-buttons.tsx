  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <button
        ...
        className={[
          "flex w-full items-center justify-center gap-3 rounded-[10px] px-4 py-3 text-sm font-medium transition-colors bg-[#5865F2]/10 border border-[#5865F2]/20 text-[#8b9aff] hover:bg-[#5865F2]/20",
          loading && loading !== "discord" ? "opacity-50" : "",
        ].join(" ")}
      >
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className={[
            "flex items-center justify-center gap-2 rounded-[10px] px-4 py-3 text-sm font-medium transition-colors bg-[#9146FF]/10 border border-[#9146FF]/20 text-[#b388ff] hover:bg-[#9146FF]/20",
            loading && loading !== "twitch" ? "opacity-50" : "",
          ].join(" ")}
        >
