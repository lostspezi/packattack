...
export interface ICoinTransaction extends Document {
  ...
  amount: number;
  type: "admin_grant" | "admin_deduct" | "pack_purchase" | "pack_refund" | "card_conversion" | "coin_purchase" | "shipping_payment" | "reservation_expired" | "battle_entry" | "battle_card_conversion" | "battle_refund" | "signup_bonus" | "tour_reward" | "achievement_reward";
  reason: string | null;
...
const CoinTransactionSchema = new Schema<ICoinTransaction>(
  {
    ...
    type: {
      type: String,
      enum: ["admin_grant", "admin_deduct", "pack_purchase", "pack_refund", "card_conversion", "coin_purchase", "shipping_payment", "reservation_expired", "battle_entry", "battle_card_conversion", "battle_refund", "signup_bonus", "tour_reward", "achievement_reward"],
      required: true,
    },
